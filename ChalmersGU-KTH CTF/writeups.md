...
I'll post a link instead : https://portswigger.net/support/sql-injection-in-the-query-structure

SO you  basically use the fact that you can do case when after order to brute the flag character by character. 
